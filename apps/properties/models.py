...
class PropertyPublishedManager(models.Manager):
    def get_queryset(self):
        return(
            super(PropertyPublishedManager, self).get_queryset().filter(published=True)
        )
...
class Property(TimeStampedUUIDModel):
    class AdvertType(models.TextChoices):
        ...
        AUTION = 'Auction',('Auction')

    class PropertyType(models.TextChoices):
        SINGLE_ROOM = 'Single_Room', _('Single_Room')
        DOUBLE_ROOM = 'Double_Room', _('Double_Room')
        BEDSITTER = 'Bedsitter', _('Bedsitter')
        ONE_BEDROOM = 'One_Bedroom',_('One_Bedroom')
        TWO_BEDROOM = 'Two_Bedroom',_('Two_Bedroom')
        THREE_BEDROOM = 'Three_Bedroom',_('Three_Bedroom')
        ...
        TERRACED_HOUSE = 'TERRACED_HOUSE', _('Terraced House')
        TERRACED_FLAT = 'TERRACED_FLAT', _('Terraced Flat')
        OTHER = 'Other', _('Other')

    
    user = models.ForeignKey(User, verbose_name= ("Agent,Renter,Seller or Buyer"),related_name= 'agent_buyer', on_delete=models.DO_NOTHING),
    ...
    property_type = models.CharField(
        ...
        default=PropertyType.SINGLE_ROOM,
    )
