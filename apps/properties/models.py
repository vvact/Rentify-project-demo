...
class Property(TimeStampedUUIDModel):
    ...
    user = models.ForeignKey(
        User,
        verbose_name=_("Agent, Renter, Seller or Buyer"),
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default=150
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=200, default="KMT Avenue"
    )
    ...
    furnished = models.BooleanField(
        verbose_name=_("Furnished"), default=False, help_text=_("Furnished")
    )
    swimming_pool = models.BooleanField(
        verbose_name=_("Swimming Pool"), default=False, help_text=_("Swimming Pool")
    )
    ...
    final_price = models.DecimalField(
        ...
        decimal_places=2,
        default=0.0,
        help_text=_("Price including tax"),
    )
...
class PropertyViews(TimeStampedUUIDModel):
    ip = models.CharField(
        verbose_name=_("IP Address"), max_length=260, default="127.0.0.1"
    )
